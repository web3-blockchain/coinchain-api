...
type NewsServiceClient interface {
	FetchNews(ctx context.Context, in *NewsRequest, opts ...grpc.CallOption) (*NewsResponse, error)
}
...
func (c *newsServiceClient) FetchNews(ctx context.Context, in *NewsRequest, opts ...grpc.CallOption) (*NewsResponse, error) {
	out := new(NewsResponse)
	err := c.cc.Invoke(ctx, NewsService_FetchNews_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NewsServiceServer interface {
	FetchNews(context.Context, *NewsRequest) (*NewsResponse, error)
...
func (UnimplementedNewsServiceServer) FetchNews(context.Context, *NewsRequest) (*NewsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FetchNews not implemented")
}
...
func _NewsService_FetchNews_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NewsServiceServer).FetchNews(ctx, req.(*NewsRequest))
	}
